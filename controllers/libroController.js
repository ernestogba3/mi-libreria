...
const libroController = {
    ...
    crearLibro: (req,res) =>{
        const {titulo,autor,estado,valoracion,fecha_inicio,fecha_fin,genero,notas} = req.body;
        ...
        libroModel.guardar(titulo,autor,estado,valoracion,fecha_inicio || null ,fecha_fin || null,genero || null,notas || null);
        res.redirect('/libros');
    },
    ...
    actualizarLibro: (req,res) =>{
        ...
        if (errores.length > 0) {
         ...
         libroModel.actualizar(req.params.id,titulo,autor,estado,valoracion,fecha_inicio || null,fecha_fin || null,genero || null, notas || null);
         res.redirect('/libros');
    },
